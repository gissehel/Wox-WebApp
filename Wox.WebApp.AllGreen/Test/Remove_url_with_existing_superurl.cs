...
namespace Wox.WebApp.AllGreen.Test
{
    public class Remove_url_with_existing_superurl : TestBase<WebAppContext>
    {
        public override void DoTest() =>
            ...
            .DoCheck(f => f.The_title_of_result__is(1), "add https://bing.com ms search")
            ...
            .Check("Start https://bing.com", "Start the url https://bing.com (ms search)")
            .EndUsing()
            ...
            .DoCheck(f => f.The_subtitle_of_result__is(1), "Start the url https://bing.com/ (bing search engine)")
